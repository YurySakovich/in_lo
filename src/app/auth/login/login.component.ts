...
export class LoginComponent implements OnInit {
  ...
  private initForm(): FormGroup {
    return this.fb.group({
      ...
      username: ['email1@test.com', [Validators.required, Validators.pattern(emailValidator)]],
      password: ['theemail1', Validators.required],
    });
  }

  public onSubmit(): void {
    this.store$.dispatch(new AuthFeatureStoreActions.LoginRequestAction(this.loginForm.value));
  }
}
